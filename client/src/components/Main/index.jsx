        ...
        <section className={styles.chat}>
          <div className={styles.myInfo}>
            <div className={styles.avatar} style={{ backgroundImage: `url(${details.avatar || defaultAvatarUrl})` }}>
              <span onClick={handleEditAvatar} className={styles.statuss}><img src={svgEditPhoto} alt="edit photo" style={{ width: '20px', height: '20px' }} /></span>
            </div>
            ...
            <div className={styles.textContainer}>
              ...
              <p className={styles.myEmail} style={{ marginLeft: '13px'}}>
                {details.email} <img onClick={handleEditEmail} src={svgEditPhoto} alt="edit photo" style={{ marginLeft: '13px', width: '13px', height: '13px' }} />
              </p>
